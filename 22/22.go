...
func main() {
	fmt.Println(bigInt("314159265358979323846264338327950288419716939937510", "14159265358979323846264338327950288419716939937510"))
}

func bigInt(a, b string) (answer string, err error) {
